...
INSERT INTO `account` VALUES (1,5500.00,1),(2,5000.00,2),(3,7500.00,3);
...
INSERT INTO `security_in_portfolio` VALUES (1,1,130,19500.00,21000.00,0.00),(2,2,50,100000.00,100000.00,0.00),(3,3,200,60000.00,60000.00,0.00);
...
INSERT INTO `transaction` VALUES (1,1,'2024-04-01','Deposit',5000.00,1),(2,2,'2024-04-01','Withdraw',2500.00,2),(3,3,'2024-04-01','Deposit',10000.00,3),(4,1,'2024-04-18','Buy',1500.00,1),(5,1,'2024-04-18','Buy',1500.00,1),(6,1,'2024-04-18','Buy',1500.00,1);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `select_portfolio`(IN p_user_name VARCHAR(255), IN p_portfolio_id INT)
BEGIN
    DECLARE v_user_id INT;
    ...
    IF v_user_id IS NULL THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'User does not exist';
    ELSE
        -- Check if the provided portfolio_id is associated with the user
        IF NOT EXISTS (SELECT * FROM portfolio_holding WHERE user_id = v_user_id AND portfolio_id = p_portfolio_id) THEN
            SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'User does not have the specified portfolio';
        ELSE
            -- Select securities within the specified portfolio
...
-- Dump completed on 2024-04-19  0:19:36
